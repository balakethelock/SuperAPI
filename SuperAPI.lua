...
function SuperAPI:OnEnable()
	...
	-- SuperAPI.SpellButton_OnClickOriginal = SpellButton_OnClick --- Fixes spell linking in chat
	...
	-- SpellButton_OnClick = SuperAPI.SpellButton_OnClick --- Fixes spell linking in chat
